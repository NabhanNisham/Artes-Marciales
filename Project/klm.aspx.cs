...
namespace Project
{
    public partial class klm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'kalaripayattu' AND District = 'Kollam'";
            ...
            cm.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'karatte' AND District = 'Kollam'";
            ...
            ab.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'Kung fu' AND District = 'Kollam'";
            ...
            fg.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'Judo' AND District = 'Kollam'";
            ...
            jkl.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'Boxing' AND District = 'Kollam'";
            ...
            op.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'Kick Boxing' AND District = 'Kollam'";
            ...
            rst.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'Jui juitsu' AND District = 'Kollam'";
            ...
            vw.CommandText = "SELECT Fedration_Name,Address,Phone_Number FROM Register WHERE MartialArts = 'Wrestling' AND District = 'Kollam'";

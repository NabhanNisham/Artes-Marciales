<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ti.aspx.cs" Inherits="Project.ti" %>
...
<nav class="navbar navbar-expand-lg bg-dark navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="align-content-center">
            <asp:GridView ID="GridView1" runat="server" class="table table-striped table-dark text-warning text-center" DataKeyNames="tid" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting">
                <Columns>
                <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
                <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete" class="text-warning" OnClientClick="return confirm('Are you sure you want to delete this record?');" />
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>
            </asp:GridView>
